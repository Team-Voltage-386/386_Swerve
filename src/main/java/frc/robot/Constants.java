...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final SwerveModule LFSwerve = new SwerveModule(14, 18, 24, kSwerveSteerPID, kSwerveDrivePID, 0.36, -0.26, 0.0, false);
        public static final SwerveModule RFSwerve = new SwerveModule(11, 15, 21, kSwerveSteerPID, kSwerveDrivePID, 0.36, 0.26, 0.0, false);
        public static final SwerveModule LRSwerve = new SwerveModule(13, 17, 23, kSwerveSteerPID, kSwerveDrivePID, -0.36, -0.26, 0.0, false);
        public static final SwerveModule RRSwerve = new SwerveModule(12, 16, 22, kSwerveSteerPID, kSwerveDrivePID, -0.36, 0.26, 0.0, false);
    }
}